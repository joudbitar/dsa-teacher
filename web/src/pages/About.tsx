      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-start gap-4 mb-8">
                <Target className="h-8 w-8 flex-shrink-0" style={{ color: '#96BFBD' }} />
                <div>
                  <h2 className="text-3xl font-bold mb-4" style={themeStyle}>
                    Our Mission
                  </h2>
                  <p className="text-lg text-[#4B463F] mb-4" style={{ fontFamily: themeStyle.fontFamily }}>
                  ...
                  <p className="text-lg text-[#4B463F]" style={{ fontFamily: themeStyle.fontFamily }}>
        ...
        <section className="py-12 sm:py-16" style={themeStyle}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-start gap-4 mb-8">
                <Heart className="h-8 w-8 flex-shrink-0" style={{ color: '#96BFBD' }} />
                <div>
                  <h2 className="text-3xl font-bold mb-4" style={themeStyle}>
                    How We Can Help
                  </h2>
                  <ul className="space-y-3 text-lg text-[#4B463F] list-disc list-inside" style={{ fontFamily: themeStyle.fontFamily }}>
                  ...
                  <p className="text-lg text-[#4B463F] mt-4 font-bold" style={{ fontFamily: themeStyle.fontFamily }}>
